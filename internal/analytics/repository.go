...
type Repository interface {
	...
	UpsertAudioFeatures(ctx context.Context, f *TrackAudioFeatures) error
...
func (r *repository) UpsertAudioFeatures(ctx context.Context, f *TrackAudioFeatures) error {
	query := `
