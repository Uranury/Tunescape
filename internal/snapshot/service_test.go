...
func (m *mockSpotifyService) GetTopTracks(ctx context.Context, userID uuid.UUID, limit int) ([]track.Track, error) {
	return m.getTopTracksFn(ctx, userID, limit)
}
...
func TestSnapshotService_CreateSnapshot_Success(t *testing.T) {
	...
	spotifySvc := &mockSpotifyService{
		getTopTracksFn: func(_ context.Context, gotUserID uuid.UUID, limit int) ([]track.Track, error) {
			if gotUserID != userID {
...
func TestSnapshotService_CreateSnapshot_EmptyTracks(t *testing.T) {
	...
	spotifySvc := &mockSpotifyService{
		getTopTracksFn: func(_ context.Context, _ uuid.UUID, _ int) ([]track.Track, error) {
